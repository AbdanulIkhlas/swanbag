      ...
      <section className="mt-[42px] ml-[21px] mr-[21.5px] md:ml-[80px] md:mr-[80px] lg:ml-[135px] lg:mr-[135px] md:mt-[82px]">
        ...
        <div className="grid grid-cols-2 mt-[19px]">
          <img
            ...
            alt=""
            className="w-[134px] h-[184px] md:w-[242px] md:h-[338px] lg:w-[494px] lg:h-[677px] mb-[35px]  rounded-tr-extraLarge rounded-bl-extraLarge"
          />
          <div className="grid grid-rows-2 ">
            <img
              src="/images/teams/team-1.png"
              alt=""
              className="w-[95px] h-[74px] md:w-[181px] md:h-[134px] lg:w-[361px] lg:h-[273px] rounded-tr-large rounded-bl-large mr-[95px] md:mr-[133px] "
            />
            <img
              src="/images/teams/team-2.png"
              alt=""
              className="w-[172px] h-[102px] md:w-[311px] md:h-[171px] lg:w-[635px] lg:h-[372px] rounded-br-large2 rounded-tl-large2  -mt-[28px] mr-[21px] md:-mt-[20px] lg:-mt-[50px]"
            />
          </div>
        </div>
      </section>
